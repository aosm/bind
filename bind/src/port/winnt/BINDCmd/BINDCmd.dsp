# Microsoft Developer Studio Project File - Name="BINDCmd" - Package Owner=<4>
...
# ADD LINK32 Advapi32.lib /nologo /subsystem:console /machine:I386 /out:"..\bin\Release\BINDCmd.exe"
...
# ADD LINK32 Advapi32.lib /nologo /subsystem:console /pdb:none /debug /machine:I386 /out:"..\bin\Debug\BINDCmd.exe"

!ENDIF 

# Begin Target

# Name "BINDCmd - Win32 Release"
# Name "BINDCmd - Win32 Debug"
# Begin Group "Sources"
